...
| [4.8](/docs/requisitos/RF-google-places-backend/4.8.CatalogoGooglePlaces.md) | **Catálogo Google Places** | **Google Places API (New) — fonte principal de POIs de Pirenópolis** |
