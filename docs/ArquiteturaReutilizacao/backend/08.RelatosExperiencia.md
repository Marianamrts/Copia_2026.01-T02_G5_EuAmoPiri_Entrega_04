...
| RF09 — painel turista | `GET /auth/me/experiences` |
| RF10 — relatos nos locais do morador | `GET /places?moradorId` + `GET .../experiences` |
| RNF05 — ordem decrescente | `experienceModel` `orderBy createdAt desc` |

Documentação de frontend: [rf08-edicao-relatos](/requisitos/rf08-edicao-relatos.md).
