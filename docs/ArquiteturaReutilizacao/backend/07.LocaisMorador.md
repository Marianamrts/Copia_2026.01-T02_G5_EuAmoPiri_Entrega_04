...
| RF10 | Painel com relatos nos locais do morador | `GET /places?moradorId` + `GET /places/:id/experiences` (composição FE) |
...
Relatos nos locais do morador: [Módulo 08 — Relatos](/ArquiteturaReutilizacao/backend/08.RelatosExperiencia.md).
